    ...
    <div className="space-y-6 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {SHRINE_TIERS.map((tier) => (
          ...
          >
            <span className="text-[10px] text-subtle font-mono block">Tier {tier.id}</span>
            <span className="text-sm font-extrabold text-text block mt-1">{tier.name}</span>
            <span className="text-[10px] text-subtle block mt-2">Gates {tier.startId} - {tier.endId}</span>
          </button>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="p-5 border border-border bg-surface rounded-2xl shadow-sm space-y-4">
            <span className="block text-[10px] font-bold text-subtle uppercase tracking-wider">Gates Checklist</span>
              ...
              {tierPoints.map((pt) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1 font-mono text-[9px] text-subtle">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-6 border border-border bg-surface rounded-2xl shadow-sm space-y-5">
            <span className="block text-[10px] font-bold text-subtle uppercase tracking-wider">Gate Details</span>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-start pb-3 border-b border-border/60">
                  <div>
                    ...
                    <span className="text-[10px] text-subtle font-mono">Battle Scene: {activePoint.battle_scene}</span>
                  </div>
                  
                  <div className="text-right">
                    <span className="text-[9px] text-subtle block uppercase font-mono">Sweep Cost</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                  <div className="p-3 border border-border/60 bg-bg/30 dark:bg-bg/5 rounded-xl space-y-1">
                    <span className="font-semibold text-subtle uppercase text-[9px] block">Next Gate Target</span>
                  ...
                  <div className="p-3 border border-border/60 bg-bg/30 dark:bg-bg/5 rounded-xl space-y-1">
                    <span className="font-semibold text-subtle uppercase text-[9px] block">Enemy Armies Assigned</span>
                    <div className="flex items-center gap-1.5">
          ...
          <div className="p-6 border border-border bg-surface rounded-2xl shadow-sm space-y-5">
            <span className="block text-[10px] font-bold text-subtle uppercase tracking-wider">Flush Spirit Offerings Simulator</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center text-xs">
                  <span className="text-muted font-bold">Offerings Altar Level</span>
                  <span className="font-mono font-bold text-amber-600 dark:text-amber-400 text-sm">Lv. {altarLevel}</span>
                </div>

                <div className="space-y-1.5 text-xs">
                  <span className="text-[10px] text-subtle block uppercase font-mono">Level Multipliers</span>
                  <div className="p-3 bg-bg/50 border border-border/60 rounded-xl space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="text-subtle">Base Buff Factor</span>
                      <span className="font-mono font-bold text-text">
                        x{activeLevelConfig?.level_coefficient.toFixed(2) || '1.00'}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-subtle">Altar Type Factor</span>
                      <span className="font-mono font-bold text-text">
              ...
              <div className="space-y-4 p-4 border border-amber-500/25 bg-amber-500/5 rounded-xl flex flex-col justify-between">
                <div className="space-y-2 text-xs">
                  <span className="text-[10px] text-subtle block uppercase font-mono">Offerings Cost</span>
                  <div className="flex justify-between items-center">
                    <span className="font-semibold text-text">Energy Consume:</span>
                    <span className="font-mono font-bold text-text">
                  ...
                  {/* Consumed stones */}
                  <div className="flex justify-between items-center">
                    <span className="font-semibold text-text">Upgrade Materials:</span>
                    <span className="font-mono font-bold text-text">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="font-semibold text-text">Success Rate:</span>
